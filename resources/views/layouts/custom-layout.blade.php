...
<head>
    ...
    <title>{{ config('app.name', 'Hazir') }}</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="/home" class="logo">
            <span class="logo-mini">HZR</span>
            <span class="logo-lg">HAZIR</span>
        </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="#" class="btn btn-default btn-flat">Chang Password</a>
                                </div>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    <p>{{ Auth::user()->name }}</p>
                    <p><a href="/adminLogout"><i class="fa fa-sign-out"></i> Signout</a></p>
                </div>
            </div>
            <!-- Sidebar Menu -->
            @yield('sideContent')
    ...
    <footer class="main-footer">
        <!-- Default to the left -->
        <strong>Copyright &copy; 2017 <a href="#">Hazir</a>.</strong>
    </footer>
</div>
<!-- ./wrapper -->
